    ...
    >
      ...
      {!confirmingCancel && (
        <div className="flex flex-col">
          <div
            className={`grid gap-0 ${!isBlock && phone && !isCancelled ? 'grid-cols-3' : !isCancelled ? 'grid-cols-2' : 'grid-cols-1'}`}
            style={{ borderBottom: !isCancelled ? '1px solid var(--border)' : undefined }}
          >
            {/* WhatsApp — solo reservas con teléfono */}
            {!isBlock && phone && (
              <a
                ...
                onClick={onClose}
                className="flex items-center justify-center gap-1 py-2.5 text-[11px] font-medium hover:bg-card-hover transition-colors"
                style={{ color: '#4dc870', borderRight: '1px solid var(--border)' }}
              >
            ...
            {/* Editar — solo no cancelados */}
            {!isCancelled && (
              <button
                onClick={onEdit ?? onOpenDetail}
                className="flex items-center justify-center gap-1.5 py-2.5 text-[12px] font-semibold text-text hover:bg-card-hover transition-colors"
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 py-2.5 text-[12px] font-medium text-muted hover:text-text hover:bg-card-hover transition-colors"
