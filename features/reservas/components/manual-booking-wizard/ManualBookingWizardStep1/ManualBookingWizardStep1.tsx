...
export default function ManualBookingWizardStep1({ date, setDate, availableDates }: ManualBookingWizardStep1Props) {
  return (
          ...
          return (
            <button
              ...
              className={`shrink-0 flex flex-col items-center gap-[2px] min-w-[46px] px-[6px] py-2
                          rounded-xl border cursor-pointer transition-all duration-[130ms] active:scale-95
                          ${
                            isActive
