    ...
    <div className="flex flex-col max-h-[85vh] overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-4 flex flex-col gap-3 [scrollbar-width:thin]">
        ...
        {showPickers && (
          <>
            {/* Date */}
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted mb-1.5">Fecha</p>
            ...
            {/* Time slots */}
            <div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-muted mb-1.5">Hora de inicio</p>
              {isLoadingSlots ? (
        ...
        {showPickers && bookingMode === 'BLOQUEO' && startTime && (
          <div>
            <p className="text-[10px] font-bold uppercase tracking-widest text-muted mb-1.5">Hora de fin</p>
      ...
      <div className="px-4 py-3 border-t border-border flex gap-2 shrink-0">
        ...
        <button type="button" onClick={handleSubmit} disabled={!canSubmit || isPending}
          ...
          ) : bookingMode === 'BLOQUEO' ? 'Confirmar bloqueo' : 'Guardar reserva'}
        </button>
      </div>
    </div>
  )
